...
adata = sc.read_10x_mtx('/home/emma/data/10X_P7_2/outs/filtered_gene_bc_matrix')
ldata = scv.read('/home/emma/data/10X_P7_2/velocyto/10X_P7_2.loom')
adata1 = scv.utils.merge(adata, ldata)

adata = sc.read_10x_mtx('/home/emma/data/10X_P7_3/outs/filtered_gene_bc_matrix')
ldata = scv.read('/home/emma/data/10X_P7_3/velocyto/10X_P7_3.loom')
adata2 = scv.utils.merge(adata, ldata)

adata_combined = adata1.concatenate(adata2, batch_key='batch')
adata_combined.write('/home/emma/data/10X_P7_2_3_marrow_bbknn.h5ad')
...
scv.pl.velocity_embedding_stream(adata, basis='genovis_perturbation', color='cell_type', save='/home/emma/result/perturbation/Pdcd4_perturbation.png', dpi=300)

# Gene specific velocity plots
scv.pl.velocity(adata, ['Pdcd4'], perc = [5, 60], save='/home/emma/result/perturbation/Pdcd4_velocity_expression.png', dpi=300)
