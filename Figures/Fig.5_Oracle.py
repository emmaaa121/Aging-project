...
ax[1].set_title("Randomized simulation vector")
plt.savefig('/home/emma/result/oracle/simulated_quiverplot.png')
plt.show()
...
plt.savefig('/home/emma/result/oracle/Marrow_perturbation.png', dpi=300)
plt.show()
...
plt.savefig('/home/emma/result/oracle/Marrow_perturbation_vector_field.png', dpi=300)
...
# Save the figure
fig.savefig('/home/emma/result/oracle/final_visualization.png', dpi=300)
